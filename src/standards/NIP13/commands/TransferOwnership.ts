...
export class TransferOwnership extends AbstractCommand {
  ...
  public arguments: string[] = [
    'sender', // must be either of TARGET or PARTITION ACCOUNT
  ...
  protected get transactions(): Transaction[] {
    ...
    if (sender.address.equals(this.target.address)) {
      // Transaction 1.01: Add ownership transfer transaction
      transactions.push(TransferTransaction.create(
        ...
        PlainMessage.create(this.descriptor + ':' + the_partition.name),
